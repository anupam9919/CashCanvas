  ...
  return (
    ...
    >
      ...
      <div className="text-center py-16 px-4 md:px-8">
        <h1
          className={`text-5xl font-extrabold mb-6 ${isDarkMode ? "text-blue-400" : "text-blue-600"
            }`}
        >
          Welcome to CashCanvas
        </h1>
        <p
          className={`text-xl mb-8 max-w-xl mx-auto ${isDarkMode ? "text-gray-300" : "text-gray-700"
            }`}
        >
        ...
        <div className="flex justify-center space-x-6">
          {!isAuthenticated && (
            <>
              <Link
                to="/signin"
                className={`${isDarkMode ? "bg-blue-500" : "bg-blue-600"
              ...
              <Link
                to="/register"
                className={`${isDarkMode ? "bg-gray-600" : "bg-gray-600"
      ...
      >
        <div className="container mx-auto text-center">
          <h2
            className={`text-3xl font-bold mb-12 ${isDarkMode ? "text-white" : "text-gray-800"
              }`}
          >
            Features of Our App
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {/* Feature 1 */}
            <div
              className={`${isDarkMode ? "bg-gray-700" : "bg-blue-50"
